...
const translations = {
  fr: {
    ...
    settings: {
      ...
      audioEngineSection:      'Moteur audio',
      audioEngineNative:       'Eigen Audio (iOS natif)',
      audioEngineNativeHelp:   'AVAudioEngine · stéréo · .caf · qualité maximale.',
      audioEngineWeb:          'Web / PWA',
      audioEngineWebHelp:      'MediaRecorder · même moteur que la version web et PWA.',
    },
    recorder: {
  ...
  en: {
    ...
    settings: {
      ...
      iosSection:              'iOS / Safari',
      audioEngineSection:      'Audio engine',
      audioEngineNative:       'Eigen Audio (iOS native)',
      audioEngineNativeHelp:   'AVAudioEngine · stereo · .caf · maximum quality.',
      audioEngineWeb:          'Web / PWA',
      audioEngineWebHelp:      'MediaRecorder · same engine as the web and PWA versions.',
    },
    recorder: {
